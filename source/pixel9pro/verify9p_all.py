...
CASE=P("case_pixel9pro.stl"); PH=P("_phone9pro_in_case.stl"); MT=to_mf(L(os.path.join(SRC,"mount.stl")))
parts={n:P(n+"_pixel9pro.stl") for n in ["top_cap","bottom_cap","bottom_cap_for_usb_cable",
...
rep(CASE,PH,"case x Pixel 9 Pro")
...
feat={"speaker":(SPK_Y0,SPK_Y1,SPK_Z0,SPK_Z1),"USB-C":(USB_Y0,USB_Y1,USB_Z0,USB_Z1),
      "mic":(MIC_Y0,MIC_Y1,MIC_Z0,MIC_Z1),"2nd hole":(AUX_Y0,AUX_Y1,AUX_Z0,AUX_Z1)}
